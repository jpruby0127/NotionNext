...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jpruby', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的健身人🏋️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.jpruby.asia', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, jpruby', // 网站关键词 英文逗号隔开
